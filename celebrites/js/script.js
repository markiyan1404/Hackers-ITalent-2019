$(".button_black_hat").click(function(){
	$(".PerehidnuyBlock").css("background", "#111");
	$(".PerehidnuyBlock").fadeIn(100);
   setTimeout(function(){
         location.href = "black/black_hat.html";
   }, 1750);
});

$(".button_white_hat").click(function(){
	$(".PerehidnuyBlock").css("background", "#FFF");
	$(".PerehidnuyBlock").fadeIn(100);
  setTimeout(function(){
         location.href = "white/white_hat.html";
   }, 1750);
});
...
function colorFun(){
    if(window_width > 767) backgroundBlack = $(".settingsModalBlock, .PerehidnuyBlockTop, .PerehidnuyBlock, .WhiteMenuBlock");
    else backgroundBlack = $(".settingsModalBlock, .settingsModalBlock_2, .PerehidnuyBlockTop, .PerehidnuyBlock, .WhiteMenuBlock");
    var backgroundWhite = $(".background_time_block, .windows_glaw_text hr, .BlackMenuBlock");
    var colorBlack = $(".flagsText, .flagBlock, .settungsIcons, .BlackText");
    var colorWhite = $(".closeSettings, .welcome_p, .glitch, .WhiteText");
...
if($("#cbx").prop("checked")){
  ...
  $(".flagUa").click(function(){$(".flagsTextUa").css("border-bottom", "2px solid #FFF");});$(".flagRu").click(function(){$(".flagsTextRu").css("border-bottom", "2px solid #FFF");});$(".flagEn").click(function(){$(".flagsTextEn").css("border-bottom", "2px solid #FFF");});
...
$(".flagUa").click(function(){
    $("body").addClass("scrollUa");
    document.title = 'знаменитості';
    localStorage.setItem('body-class', 'scrollUa');
    localStorage.setItem('title', 'знаменитості');
...
$(".flagRu").click(function(){
    $("body").addClass("scrollRu");
    document.title = 'знаменитости';
    localStorage.setItem('body-class', 'scrollRu');
    localStorage.setItem('title', 'знаменитости');
...
$(".flagEn").click(function(){
    ...
    localStorage.setItem('title', 'celebrities');
    if($("body").hasClass('scrollUa')){
          localstorage.removeItem('body-class', 'scrollUa');
    }
    if($("body").hasClass('scrollRu')){
