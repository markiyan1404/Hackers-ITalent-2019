...
var cursor = document.getElementById('cursor');
  ...
  $("#cursor").fadeIn();
    ...
    if($(".mySlides4").hasClass("activeSlide")){$("#cursor").css("border-color", "#FCFE5E");$("#cursor").css("box-shadow", "0px 0px 30px #FCFE5E");}
...
$(".slideImg1").click(function(){
    $(".PerehidnuyBlock").css("display", "block");
    setTimeout(function(){
    location.href = "kevin/kevin.html"
  }, 1650);
}); 
...
$(".slideImg2").click(function(){
    $(".PerehidnuyBlock").css("display", "block");
    setTimeout(function(){
    location.href = "jeanson/jeanson.html"
  }, 1650);
}); 
...
$(".slideImg4").click(function(){
    $(".PerehidnuyBlock").css("display", "block");
    setTimeout(function(){
    location.href = "albert/albert.html"
  }, 1650);
}); 
...
$(".slideImg5").click(function(){
    $(".PerehidnuyBlock").css("display", "block");
    setTimeout(function(){
    location.href = "raven/raven.html"
  }, 1650);
}); 
...
$(".flagUa").click(function(){
    $("body").addClass("scrollUa");
    document.title = 'чорні капелюхи';
    localStorage.setItem('body-class', 'scrollUa');
    localStorage.setItem('title', 'чорні капелюхи');
...
$(".flagRu").click(function(){
    $("body").addClass("scrollRu");
    document.title = 'черные шляпы';
    localStorage.setItem('body-class', 'scrollRu');
    localStorage.setItem('title', 'черные шляпы');
...
$(".flagEn").click(function(){
    $("body").addClass("scrollEn");
    document.title = 'black hats';
    localStorage.setItem('body-class', 'scrollEn');
    localStorage.setItem('title', 'black hats');
    if($("body").hasClass('scrollUa')){
          localstorage.removeItem('body-class', 'scrollUa');
    }
    if($("body").hasClass('scrollRu')){
